...
public class ConsultaReciboServico {
  ...
  public ConsultaReciboServico(string recibo) { _recibo = recibo; }

  public retConsReciCTe
  Consultar(ConfiguracaoServico configuracaoServico = null) {
  ...
  public async Task<retConsReciCTe>
  ConsultarAsync(ConfiguracaoServico configuracaoServico = null) {
    var configServico = configuracaoServico ?? ConfiguracaoServico.Instancia;
    ...
    var webService = WsdlFactory.CriaWsdlCteRetRecepcao(configServico);
    var retornoXml =
        await webService.cteRetRecepcaoAsync(consReciCTe.CriaRequestWs());
