...
public class ConsultaProtcoloServico {
  public retConsSitCTe
  ConsultaProtocolo(string chave,
  ...
  public retConsSitCTe
  ConsultaProtocoloV4(string chave,
                      ConfiguracaoServico configuracaoServico = null) {
    var configServico = configuracaoServico ?? ConfiguracaoServico.Instancia;
  ...
  public async Task<retConsSitCTe>
  ConsultaProtocoloAsync(string chave,
                         ConfiguracaoServico configuracaoServico = null) {
    var configServico = configuracaoServico ?? ConfiguracaoServico.Instancia;
    ...
    var webService = WsdlFactory.CriaWsdlConsultaProtocolo(configServico);
    var retornoXml =
        await webService.cteConsultaCTAsync(consSitCTe.CriaRequestWs());
