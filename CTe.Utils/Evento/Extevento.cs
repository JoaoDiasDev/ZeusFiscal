...
public static class Extevento {
  ...
  /// <returns>Retorna uma string no formato XML com os dados do objeto
  /// evento</returns>
  ...
  public static void Assina(this eventoCTe eventoCTe,
    ...
    if (eventoCTe.infEvento.Id == null)
      throw new Exception(
          "Não é possível assinar um objeto evento sem sua respectiva Id!");

    eventoCTe.Signature = AssinaturaDigital.Assina(
        eventoCTe, eventoCTe.infEvento.Id, configServico.X509Certificate2);
  }

  public static void
  ValidarSchema(this eventoCTe eventoCTe,
                ConfiguracaoServico configuracaoServico = null) {
    var configServico = configuracaoServico ?? ConfiguracaoServico.Instancia;
    ...
    ValidarSchemaEventoContainer(eventoCTe.infEvento.detEvento.EventoContainer,
                                 eventoCTe.versao, configuracaoServico);
  }

  private static void
  ValidarSchemaEventoContainer(EventoContainer container, versao versao,
                               ConfiguracaoServico configuracaoServico = null) {
    var configServico = configuracaoServico ?? ConfiguracaoServico.Instancia;
    ...
    if (container.GetType() == typeof(evCancCTe)) {
      ...
      case versao.ve300:
        ...
        break;
      case versao.ve400:
        Validador.Valida(xmlEventoCancelamento, "evCancCTe_v4.00.xsd",
                         configServico);
        break;
      default:
        throw new InvalidOperationException(
    ...
    if (container.GetType() == typeof(evPrestDesacordo)) {
      ...
      case versao.ve300:
        ...
        break;
      case versao.ve400:
        Validador.Valida(xmlEventoCCe, "evPrestDesacordo_v4.00.xsd",
                         configServico);
        break;
      default:
        throw new InvalidOperationException(
  ...
  public static void
  SalvarXmlEmDisco(this eventoCTe eventoCTe,
                   ConfiguracaoServico configuracaoServico = null) {
    ...
    var arquivoSalvar =
        Path.Combine(caminhoXml, eventoCTe.infEvento.chCTe + "-ped-eve.xml");
