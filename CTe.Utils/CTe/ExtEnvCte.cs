...
public static class ExtEnvCte {
  public static void
  ValidaSchema(this enviCTe enviCTe,
  ...
  public static void
  SalvarXmlEmDisco(this enviCTe enviCte,
                   ConfiguracaoServico configuracaoServico = null) {
    ...
    var arquivoSalvar =
        Path.Combine(caminhoXml, enviCte.idLote + "-env-lot.xml");

    FuncoesXml.ClasseParaArquivoXml(enviCte, arquivoSalvar);
  }

  public static XmlDocument
  CriaRequestWs(this enviCTe enviCTe,
                ConfiguracaoServico configuracaoServico = null) {
