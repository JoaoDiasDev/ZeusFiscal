...
public static class ExtConsReciCTe {
  public static void
  ValidarSchema(this consReciCTe consReciCTe,
  ...
  SalvarXmlEmDisco(this consReciCTe consReciCTe,
    ...
    var arquivoSalvar =
        Path.Combine(caminhoXml, consReciCTe.nRec + "-ped-rec.xml");
  ...
  public static void
  SalvarXmlEmDisco(this retConsReciCTe retConsReciCTe,
                   ConfiguracaoServico configuracaoServico = null) {
    var instanciaServico = configuracaoServico ?? ConfiguracaoServico.Instancia;
    ...
    var arquivoSalvar =
        Path.Combine(caminhoXml, retConsReciCTe.nRec + "-rec.xml");
