...
public static class ExtinutCTe {
  public static void Assinar(this inutCTe inutCTe,
    ...
    inutCTe.Signature = AssinaturaDigital.Assina(
        inutCTe, inutCTe.infInut.Id, configServico.X509Certificate2);
  }
  ...
  public static void
  ValidarSchema(this inutCTe inutCTe,
                ConfiguracaoServico configuracaoServico = null) {
    var configServico = configuracaoServico ?? ConfiguracaoServico.Instancia;
  ...
  public static void
  SalvarXmlEmDisco(this inutCTe inutCTe,
                   ConfiguracaoServico configuracaoServico = null) {
    ...
    var arquivoSalvar =
        Path.Combine(caminhoXml, inutCTe.infInut.Id + "-ped-inu.xml");
