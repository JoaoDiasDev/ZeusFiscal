...
public static class ExtconsStatServCte {
  public static void
  ValidarSchema(this consStatServCte consStatServCte,
    ...
    case versao.ve300:
      ...
      break;
    case versao.ve400:
      Validador.Valida(xmlValidacao, "consStatServCTe_v4.00.xsd",
                       configServico);
      break;
    default:
  ...
  public static void
  SalvarXmlEmDisco(this consStatServCte statuServCte,
                   ConfiguracaoServico configuracaoServico = null) {
    ...
    var arquivoSalvar = Path.Combine(
        caminhoXml, DateTime.Now.ParaDataHoraString() + "-ped-sta.xml");

    FuncoesXml.ClasseParaArquivoXml(statuServCte, arquivoSalvar);
  }

  public static XmlDocument
  CriaRequestWs(this consStatServCte consStatServMdFe) {
